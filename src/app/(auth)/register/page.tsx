                                ...
                                <div className="card mb-0">
                                    <div className="card-body">
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputtext3" className="form-label">Referral Code</label>
                                                <input type="text" className="form-control"  {...register('referralcode')} defaultValue={formData.referralcode} onChange={(e) => setValue("referralcode", e.target.value, { shouldValidate: true })} id="exampleInputtext3" aria-describedby="textHelp" />
                                                {errors.referralcode && (
                                                    <div className="text-danger">
