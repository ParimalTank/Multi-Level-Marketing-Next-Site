...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 89205)), "/Users/mac/Documents/untitled folder/mlm user penal/src/app/(dashboard)/package/page.tsx"],
...
const pages = ["/Users/mac/Documents/untitled folder/mlm user penal/src/app/(dashboard)/package/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(dashboard)/package/page";
const __next_app__ = {
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/mac/Documents/untitled folder/mlm user penal/src/components/Navbar.tsx`)
...
;// CONCATENATED MODULE: ./src/utils/withAuth.tsx
...
var axios = __webpack_require__(48760);
;// CONCATENATED MODULE: ./src/app/(dashboard)/package/page.tsx
...
async function Dashboard() {
    ...
    const getPackageData = async ()=>{
        await axios/* default */.Z.get("http://localhost:3000/api/package").then((res)=>{
    ...
    const getUserData = async ()=>{
        ...
        await axios/* default */.Z.post("http://localhost:3000/api/user", {
            token
        }).then((res)=>{
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("thead", {
                                                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ jsx_runtime_.jsx("th", {
                                                                scope: "col",
                                                                children: "Purchase Date & Time"
                                                            })
                                                        ]
                                                    })
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("tbody", {
                                                    children: packageDetails.map((result, index)=>{
                                                        const date = new Date(result.createdAt);
                                                        const time = new Date(date).toLocaleString(undefined, {
...
/* harmony default export */ const page = (utils_withAuth(Dashboard));
...
var __webpack_exports__ = __webpack_require__.X(0, [8478,401,77,6034,6668,2038,8760,6133,6362,5118], () => (__webpack_exec__(10048)));
